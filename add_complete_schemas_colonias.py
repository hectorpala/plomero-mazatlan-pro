...
# Coordenadas GPS reales de colonias principales en Mazatlán, Sinaloa
COLONIAS_GPS = {
    ...
    "nuevo-mazatlan": {"lat": 24.7900, "lng": -107.4250, "street": "Av. Nuevo Mazatlán"},
...
def create_complete_schema_graph(colonia_slug, colonia_gps):
    ...
    url = f"https://plomeromazatlanpro.mx/servicios/plomero-colonias-mazatlan/{colonia_slug}/"
    ...
    graph = {
        ...
        "@graph": [
            # 1. WebSite
            {
                ...
                "logo": "https://plomeromazatlanpro.mx/assets/icons/logo-blue.svg"
            },
            # 2. HomeAndConstructionBusiness
            {
                "@type": "HomeAndConstructionBusiness",
                "@id": f"https://plomeromazatlanpro.mx/#business-{colonia_slug}",
                "name": f"Plomero Mazatlán Pro - {colonia_name}",
                "url": url,
            ...
            {
                "@type": "Service",
                "@id": f"https://plomeromazatlanpro.mx/#service-plomeria-{colonia_slug}",
                "serviceType": f"Plomería Residencial en {colonia_name}",
                "name": f"Plomero Certificado en {colonia_name} Mazatlán",
                "description": f"Servicio profesional de plomería en {colonia_name}, Mazatlán. Reparación de fugas, destape de drenajes, instalación de sanitarios, mantenimiento de boiler. Atención 24/7 con llegada rápida.",
                "provider": {
                    "@id": f"https://plomeromazatlanpro.mx/#business-{colonia_slug}"
                },
                "areaServed": {
                ...
                "image": {
                    "@type": "ImageObject",
                    "url": "https://plomeromazatlanpro.mx/assets/images/reparacion-fugas-800w.webp",
                    "width": 800,
                    "height": 800
                }
            },
            ...
            {
                "@type": "LocalBusiness",
                "@id": f"https://plomeromazatlanpro.mx/#localbusiness-{colonia_slug}",
                "name": f"Plomero Mazatlán Pro - {colonia_name}",
                "description": f"Servicio profesional de plomería en {colonia_name}, Mazatlán. Atención 24/7 con llegada rápida.",
                "url": url,
                "telephone": "+526691325300",
                "email": "contacto@plomeromazatlanpro.mx",
                "address": {
                    "@type": "PostalAddress",
...
def add_schemas_to_page(colonia_slug, colonia_gps):
    ...
    index_file = Path(f"servicios/plomero-colonias-mazatlan/{colonia_slug}/index.html")
