...
# Base directory
base_dir = Path("servicios/plomero-colonias-mazatlan")
...
for colonia_dir in colonias:
    ...
    breadcrumb_schema = f'''        ,
        {{
            "@type": "BreadcrumbList",
            "@id": "https://plomeromazatlanpro.mx/servicios/plomero-colonias-mazatlan/{colonia_slug}/#breadcrumb",
            "itemListElement": [
                {{
                    "@type": "ListItem",
                    "position": 1,
                ...
                {{
                    ...
                    "item": "https://plomeromazatlanpro.mx/servicios/plomero-colonias-mazatlan/{colonia_slug}/"
                }}
            ]
        }}'''
