...
a todas las páginas de colonias en Mazatlán.
...
def main():
    ...
    for colonia_slug, colonia_gps in COLONIAS_GPS.items():
        ...
        if result:
            added_count += 1
        elif result is False and '"@type": "LocalBusiness"' in open(f"servicios/plomero-colonias-mazatlan/{colonia_slug}/index.html").read():
            skipped_count += 1
        else:
            error_count += 1
