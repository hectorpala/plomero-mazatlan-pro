...
def main():
    siteUrl = "sc-domain:plomeromazatlanpro.mx"
    feedpath = "https://plomeromazatlanpro.mx/sitemap.xml"
    ...
    try:
        ...
        if "403" in str(e):
            ...
            print("Debes verificar https://plomeromazatlanpro.mx/ en Search Console primero")
        elif "404" in str(e):
            print("❌ Error 404: El sitemap no es accesible")
            print("Verifica que https://plomeromazatlanpro.mx/sitemap.xml esté disponible")
        else:
            print(f"❌ Error: {e}")
