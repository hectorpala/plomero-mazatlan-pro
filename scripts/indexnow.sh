...
# Uso: ./scripts/indexnow.sh "https://plomeromazatlanpro.mx/servicios/nueva-pagina/"
# O para múltiples URLs: ./scripts/indexnow.sh url1 url2 url3

KEY="f7648833b7167b4e80927a493e8e3a45"
HOST="plomeromazatlanpro.mx"
KEY_LOCATION="https://${HOST}/${KEY}.txt"

if [ $# -eq 0 ]; then
    echo "Uso: $0 <url1> [url2] [url3] ..."
    echo "Ejemplo: $0 https://plomeromazatlanpro.mx/servicios/nueva-pagina/"
    exit 1
fi
