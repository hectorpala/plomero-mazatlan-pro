#!/usr/bin/env python3
"""
Sistema de Internal Linking Automático para plomeromazatlanpro.mx
...
BLOG_TO_SERVICES = {
    ...
    "cuanto-cuesta-cambiar-taza-bano-mazatlan": [
        ("instalacion-de-sanitarios", "instalación profesional de sanitarios"),
        ("plomero-precios", "precios de servicios de plomería")
    ],
    "cuanto-cobra-plomero-visita-mazatlan": [
        ("plomero-precios", "precios de servicios de plomería en Mazatlán"),
        ("plomero-cerca-de-mi", "plomero cerca de ti")
    ],
    "como-identificar-buen-plomero-mazatlan": [
    ...
    "cuanto-cuesta-plomeria-bano-completo-mazatlan": [
...
RELATED_ARTICLES = {
    "drenaje-tapado-senales-prevencion": [
        ...
        ("problemas-comunes-plomeria-mazatlan", "Problemas comunes de plomería en Mazatlán")
    ],
    "como-detectar-fugas-agua-casa": [
        ("baja-presion-agua-causas-soluciones", "Causas de baja presión de agua"),
        ("problemas-comunes-plomeria-mazatlan", "Problemas comunes de plomería")
    ],
    "baja-presion-agua-causas-soluciones": [
    ...
    "cuanto-cuesta-cambiar-taza-bano-mazatlan": [
        ("cuanto-cuesta-plomeria-bano-completo-mazatlan", "Costo de plomería de baño completo"),
        ("cuanto-cobra-plomero-visita-mazatlan", "Cuánto cobra un plomero por visita")
    ],
    "cuanto-cobra-plomero-visita-mazatlan": [
        ("cuanto-cuesta-cambiar-taza-bano-mazatlan", "Costo de cambiar taza de baño"),
        ("como-identificar-buen-plomero-mazatlan", "Cómo identificar un buen plomero")
    ],
    "como-identificar-buen-plomero-mazatlan": [
        ("cuanto-cobra-plomero-visita-mazatlan", "Cuánto cobra un plomero"),
    ...
    "instalacion-tinaco-guia-compra": [
        ("cuanto-cuesta-plomeria-bano-completo-mazatlan", "Costo de plomería completa"),
...
def add_contextual_link(content, keyword, url, anchor_text, context_before="", context_after=""):
    ...
    if match:
        ...
        elif '/servicios/plomero-colonias-mazatlan/' in content[:1000]:
            # Estamos en colonia
            link_url = f'../../{url}/'
        else:
            # Estamos en servicio
...
def add_service_callout(content, service_slug, anchor_text):
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 24px; border-radius: 8px; margin: 24px 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <p style="margin: 0; font-size: 16px; line-height: 1.6;">
            💡 <strong>¿Necesitas ayuda profesional?</strong> Contamos con <a href="../servicios/{service_slug}/" style="color: #ffd700; text-decoration: underline;">{anchor_text}</a> con llegada rápida en Mazatlán.
        </p>
    </div>
"""
...
def main():
    ...
    colonias = [
        ...
        "las-palmas", "nuevo-mazatlan", "infonavit-humaya", "bachigualato",
    ...
    for colonia_slug in colonias:
        file_path = Path(f"servicios/plomero-colonias-mazatlan/{colonia_slug}/index.html")
        if file_path.exists():
