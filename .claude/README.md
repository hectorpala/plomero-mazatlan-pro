# Configuración de Claude Code - Plomero Mazatlán Pro

**Proyecto**: plomeromazatlanpro.mx
...
```
- SHORT_SHA: a1b2c3d
- PROD_URL: https://plomeromazatlanpro.mx/?v=a1b2c3d
...
3. @gitops-publisher-turbo:
   ...
   - Push a GitHub
   - Verifica deployment
   - Entrega URL: https://plomeromazatlanpro.mx/?v=abc123d
4. Listo
```
