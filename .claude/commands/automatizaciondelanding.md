...
1. Template base en: `index.html` (página principal https://plomeromazatlanpro.mx/)
2. Script ejecutable: `scripts/crear-landing-auto.sh`
3. Imagen hero en: `assets/images/optimizadas/{slug}-mazatlan-800w.webp`
...
- La imagen hero debe llamarse: `{slug}-mazatlan-800w.webp`
