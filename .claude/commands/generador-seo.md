...
Genera contenido SEO optimizado para un servicio de plomería en Mazatlán.
...
Debes generar contenido optimizado para SEO específico para servicios de plomería en Mazatlán, Sinaloa, México.

### 1. **Title** (50-60 caracteres)
- Debe incluir el servicio + "Mazatlán"
- Incluir un beneficio clave o valor agregado
- Entre 50-60 caracteres EXACTOS
- Ejemplo: `Reparación de Fugas Mazatlán | Plomero Profesional`

### 2. **Meta Description** (120-155 caracteres)
- Emoji inicial 🔧
- Descripción del servicio
- Beneficio principal
- Call to action con teléfono 669 132 5300
- Entre 120-155 caracteres EXACTOS
- Ejemplo: `🔧 Reparación de fugas en Mazatlán. Detección y reparación en el día. Garantía por escrito. ¡Llama: 669 132 5300!`

### 3. **Keywords** (6-8 keywords separadas por comas)
- Formato: keyword1 mazatlan, keyword2 mazatlan, plomero mazatlan...
- Incluir variaciones long-tail
- Todas en minúsculas, sin acentos
- Ejemplo: `reparacion fugas mazatlan, fugas de agua mazatlan, plomero fugas mazatlan, detectar fugas mazatlan`

### 4. **H1** (título principal)
- Debe incluir el servicio + "Mazatlán"
- Incluir beneficio clave
- Formato: "Servicio en Mazatlán | Beneficio"
- Ejemplo: `Reparación de Fugas en Mazatlán | Detección y Reparación Profesional`
...
- 30-50 palabras
- Ejemplo: `Servicio profesional de reparación de fugas de agua en Mazatlán. Detectamos y reparamos fugas en tuberías, llaves, inodoros y regaderas. Atención rápida y garantía por escrito.`
...
1. **SIEMPRE incluir "Mazatlán"** en title, description, h1, keywords
2. **Teléfono siempre es 669 132 5300**
